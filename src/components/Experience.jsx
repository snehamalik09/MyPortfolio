...
const Experience = () => {
    ...
    const links = [
        {
            id: 1,
            title:"evelopment and Research Trainee",
            src: drdo,
            companyname: "Defence Research and Development Organisation - INMAS Lab",
            duration: "Jun'23 - Present",
            experience:"As a Development and Research Intern, I processed EEG signals for epilepsy detection and multiworkload analysis using Python, applying existing machine learning algorithms and conducting data analysis.",
        },
        {
            id: 2,
            src: certificate,
