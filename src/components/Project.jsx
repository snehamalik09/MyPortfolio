...
const Project = () => {
    const links = [
        {
            id: 1,
            imagelink: healthWebsite,
            link : 'https://thefitnesshub1.netlify.app/',
            code: 'https://github.com/snehamalik09/Health_and_Fitness_Website',
            heading: "Health and Fitness Hub",
        },
        {
            id: 2,
    ...
    <>
            <div name="Project" id="Project" className='hidden md:flex md:flex-col md:w-full w-[90%] justify-center mx-auto md:mt-48 lg:gap-36 '>
                ...
                <div className=' flex flex-col md:max-w-screen-lg w-full justify-center mx-auto   '>
                    <div className='grid gap-8 grid-cols-2 md:grid-cols-3 md:px-0 px-10 cursor-pointer  '>
                        {links.map((item) => (
                            <div key={item.id} className='shadow-md shadow-gray-700 rounded-lg bg-white transition-all duration-300 delay-100 hover:scale-110'>
